...
var (
	...
	ErrInvalidMeterType                         = errors.Register(ModuleName, 18, "invalid meter type")
	...
	ErrInvalidModProviderDuplicateContractRates = errors.Register(ModuleName, 29, "contract rates must be unique")
	ErrInvalidModProviderRate                   = errors.Register(ModuleName, 30, "invalid rate")
)
