...
func (k *MemStore) fetchContract(key string) (types.Contract, error) {
	...
	type fetchContract struct {
		ProviderPubKey common.PubKey      `protobuf:"bytes,1,opt,name=provider_pub_key,json=providerPubKey,proto3,casttype=github.com/ArkeoNetwork/arkeo-protocol/common.PubKey" json:"provider_pub_key,omitempty"`
		Chain          common.Chain       `protobuf:"varint,2,opt,name=chain,proto3,casttype=github.com/ArkeoNetwork/arkeo-protocol/common.Chain" json:"chain,omitempty"`
		Client         common.PubKey      `protobuf:"bytes,3,opt,name=client,proto3,casttype=github.com/ArkeoNetwork/arkeo-protocol/common.PubKey" json:"client,omitempty"`
		Delegate       common.PubKey      `protobuf:"bytes,4,opt,name=delegate,proto3,casttype=github.com/ArkeoNetwork/arkeo-protocol/common.PubKey" json:"delegate,omitempty"`
