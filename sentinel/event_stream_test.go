...
func newTestConfig() conf.Configuration {
	...
	return conf.Configuration{
		...
		PayPerBlockTierRateLimit:         10,
		PayPerBlockTierRateLimitDuration: time.Second,
		PayPerCallTierRateLimit:          10,
		PayPerCallRateLimitDuration:      time.Second,
		ClaimStoreLocation:               "",
...
func TestHandleOpenContractEvent(t *testing.T) {
	...
	inputContract := types.Contract{
		...
		Options:            types.ContractOptions{MeterType: types.MeterType_PAY_PER_CALL},
		Height:             100,
		Duration:           100,
