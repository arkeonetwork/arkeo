...
function createBaseMsgClaimEth(): MsgClaimEth {
  return { creator: new Uint8Array(0), ethAddress: "", signature: "" };
}
...
function createBaseMsgClaimArkeo(): MsgClaimArkeo {
  return { creator: new Uint8Array(0) };
}
...
export const MsgClaimArkeo = {
  ...
  fromJSON(object: any): MsgClaimArkeo {
    return { creator: isSet(object.creator) ? bytesFromBase64(object.creator) : new Uint8Array(0) };
  },
...
function createBaseMsgTransferClaim(): MsgTransferClaim {
  return { creator: new Uint8Array(0), toAddress: new Uint8Array(0) };
}
...
function createBaseMsgAddClaim(): MsgAddClaim {
  return { creator: new Uint8Array(0), chain: 0, address: "", amount: 0 };
}
