...
export interface MercuryQueryAllContractResponse {
  contract?: MercuryContract[];
...
export interface MercuryQueryAllProviderResponse {
...
export interface MercuryQueryFetchContractResponse {
  contract?: MercuryContract;
}

export interface MercuryQueryFetchProviderResponse {
  provider?: MercuryProvider;
}
